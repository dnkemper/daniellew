...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/insideartsci.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://insideartsci.wustl.edu';
