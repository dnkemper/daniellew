...
if (getenv('IS_DDEV_PROJECT') == 'true') {
  ...
  $db_name = 'drupal_migrate';
  $d7_name = 'd7_deps_migrate';
...
$settings['olympian_migration_source_uri_prefix'] = 'https://migrate.wustl.edu/';
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/migrate.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://migrate.wustl.edu';
