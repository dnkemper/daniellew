...
if (getenv('IS_DDEV_PROJECT') == 'true') {
  ...
  $config['config_split.config_split.live']['status'] = $_ENV['LIVE'] ?? 'TRUE';
}

$databases['default']['default'] = array(
    'database' => 'drupal_johnmaxwulfing',
...
$settings['olympian_migration_source_uri_prefix'] = $_ENV['D7_SITE'] ?? 'https://johnmaxwulfing.wustl.edu/';
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/johnmaxwulfing.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://johnmaxwulfing.wustl.edu';
...
$settings['shared_configuration.source.constants.public_file_path'] = $_ENV['D7_SITE_FILES'] ?? 'https://johnmaxwulfing.wustl.edu/files/johnmaxwulfing/';
