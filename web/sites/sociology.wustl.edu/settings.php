...
// TODO: was commented out on server so commiting that change but noting it here just in case
// $config['stage_file_proxy.settings']['origin_dir'] = 'sites/sociology.wustl.edu/files';
// $config['stage_file_proxy.settings']['origin'] = 'https://sociology.wustl.edu';
