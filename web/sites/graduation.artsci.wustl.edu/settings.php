...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/graduation.artsci.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://graduation.artsci.wustl.edu';
