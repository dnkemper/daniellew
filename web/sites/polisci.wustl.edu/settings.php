...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/polisci.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://polisci.wustl.edu';
