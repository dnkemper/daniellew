...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/ealc.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://ealc.wustl.edu';
