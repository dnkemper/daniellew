...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/forms.artsci.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://forms.artsci.wustl.edu';
$settings["simple_environment_indicator"] = $_ENV['SIMPLE_ENV'] ?? '#177AA3 Local';
