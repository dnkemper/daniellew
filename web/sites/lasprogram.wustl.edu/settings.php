...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/lasprogram.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://lasprogram.wustl.edu';
