...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/amcs.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://amcs.wustl.edu';
