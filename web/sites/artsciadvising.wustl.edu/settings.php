...
'database' => 'drupal_artsciadvising',
...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/artsciadvising.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://artsciadvising.wustl.edu';
