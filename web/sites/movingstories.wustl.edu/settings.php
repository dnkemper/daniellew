...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/movingstories.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://movingstories.wustl.edu';
