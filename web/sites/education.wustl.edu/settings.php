...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/education.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://education.wustl.edu';
