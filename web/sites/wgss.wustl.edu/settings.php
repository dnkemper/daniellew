...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/wgss.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://wgss.wustl.edu';
