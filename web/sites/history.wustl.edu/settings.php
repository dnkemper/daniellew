...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/history.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://history.wustl.edu';
