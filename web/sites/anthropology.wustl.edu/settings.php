...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/anthropology.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://anthropology.wustl.edu';
