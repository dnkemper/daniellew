...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/slavery.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://slavery.wustl.edu';
