...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/economics.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://economics.wustl.edu';
