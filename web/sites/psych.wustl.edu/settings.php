...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/psych.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://psych.wustl.edu';
