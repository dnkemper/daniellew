...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/precollege.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://precollege.wustl.edu';
