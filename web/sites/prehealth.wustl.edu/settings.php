...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/prehealth.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://prehealth.wustl.edu';
