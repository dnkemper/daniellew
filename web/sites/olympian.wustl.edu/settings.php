...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/olympian.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://olympian.wustl.edu';
