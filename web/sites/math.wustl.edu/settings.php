...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/math.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://math.wustl.edu';
