...
$settings['shared_content_is_aggregator'] = TRUE;
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/aggregator.artsci.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://aggregator.artsci.wustl.edu';
