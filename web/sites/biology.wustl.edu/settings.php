...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/biology.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://biology.wustl.edu';
