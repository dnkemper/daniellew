...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/english.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://english.wustl.edu';
