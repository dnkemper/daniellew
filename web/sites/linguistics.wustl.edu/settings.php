...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/linguistics.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://linguistics.wustl.edu';
