...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/summersession.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://summersession.wustl.edu';
