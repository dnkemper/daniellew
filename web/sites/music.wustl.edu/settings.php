...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/music.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://music.wustl.edu';
