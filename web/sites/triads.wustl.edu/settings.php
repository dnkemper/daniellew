...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/triads.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://triads.wustl.edu';
