...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/literacies.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://literacies.wustl.edu';
