...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/strategicplan.artsci.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://strategicplan.artsci.wustl.edu';
