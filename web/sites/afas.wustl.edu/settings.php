...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/afas.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://afas.wustl.edu';
