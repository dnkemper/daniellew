...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/humanities.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://humanities.wustl.edu';
