...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/mcss.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://mcss.wustl.edu';
