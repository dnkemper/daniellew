...
if (getenv('IS_DDEV_PROJECT') == 'true') {
  ...
  $databases['default']['default'] = [
    'database' => 'drupal_collegewriting',
...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/collegewriting.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://collegewriting.wustl.edu';
