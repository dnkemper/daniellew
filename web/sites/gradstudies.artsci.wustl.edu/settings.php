...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/gradstudies.artsci.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://gradstudies.artsci.wustl.edu';
