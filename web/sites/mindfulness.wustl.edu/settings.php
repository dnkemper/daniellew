...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/mindfulness.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://mindfulness.wustl.edu';
