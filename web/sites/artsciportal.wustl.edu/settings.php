...
$settings["simple_environment_indicator"] = "#177AA3 Local";
$settings['trusted_host_patterns'] = [
  '^wustl\.edu$',
  '^.+\.wustl\.edu$',
  '^washu\.edu$',
...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/artsciportal.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://artsciportal.wustl.edu';
$config['config_split.config_split.webform_upload']['status'] = TRUE;
$settings["simple_environment_indicator"] = $_ENV['SIMPLE_ENV'] ?? '#177AA3 Local';
$config['config_split.config_split.secure_content']['status'] = TRUE;
