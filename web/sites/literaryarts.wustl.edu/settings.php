...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/literaryarts.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://literaryarts.wustl.edu';
