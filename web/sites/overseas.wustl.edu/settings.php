...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/overseas.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://overseas.wustl.edu';
