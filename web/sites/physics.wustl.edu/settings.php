...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/physics.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://physics.wustl.edu';
