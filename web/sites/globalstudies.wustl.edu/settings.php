...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/globalstudies.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://globalstudies.wustl.edu';
