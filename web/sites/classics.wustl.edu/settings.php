...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/classics.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://classics.wustl.edu';
