 ...
 * a small number of your site's default enst language interface strings.
 *
...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/enst.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://enst.wustl.edu';
