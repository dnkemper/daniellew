...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/eeps.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://eeps.wustl.edu';
