...
'database' => 'drupal_undergradresearch',
...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/undergradresearch.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://undergradresearch.wustl.edu';
