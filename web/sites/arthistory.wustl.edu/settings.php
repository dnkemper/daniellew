...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/arthistory.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://arthistory.wustl.edu';
