...
'database' => 'drupal_religiousstudies',
...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/religiousstudies.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://religiousstudies.wustl.edu';
