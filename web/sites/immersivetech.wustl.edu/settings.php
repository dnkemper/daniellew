...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/immersivetech.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://immersivetech.wustl.edu';
