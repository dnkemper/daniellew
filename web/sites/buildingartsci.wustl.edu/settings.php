...
$databases['default']['default'] = array(
    'database' => 'drupal_buildingartsci',
...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/buildingartsci.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://buildingartsci.wustl.edu';
$settings["simple_environment_indicator"] = $_ENV['SIMPLE_ENV'] ?? '#177AA3 Local';$config['image.settings']['suppress_itok_output'] = TRUE;
