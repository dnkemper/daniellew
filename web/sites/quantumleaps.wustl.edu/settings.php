...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/quantumleaps.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://quantumleaps.wustl.edu';
