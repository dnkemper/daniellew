...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/jimes.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://jimes.wustl.edu';
