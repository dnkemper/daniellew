 ...
 * a small number of your site's default fms language interface strings.
 *
...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/fms.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://fms.wustl.edu';
