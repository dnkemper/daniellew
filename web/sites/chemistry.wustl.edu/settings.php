...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/chemistry.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://chemistry.wustl.edu';
