...
$config['stage_file_proxy.settings']['origin_dir'] = 'sites/philosophy.wustl.edu/files';
$config['stage_file_proxy.settings']['origin'] = 'https://philosophy.wustl.edu';
