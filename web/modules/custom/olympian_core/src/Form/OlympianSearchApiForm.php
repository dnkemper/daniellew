 ...
 */
class OlympianSearchApiForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'olympian_search_api_form_block';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, array $search_config = []) {
    $form['#attributes']['class'][] = 'form-inline clearfix olympian-search-form';
    ...
    $form['actions']['submit'] = [
      '#type' => 'submit',
      '#value' => t('<svg class="icon"><use xlink:href="#icon-search"></use></svg>'),
      '#markup' => '<svg class="icon"><use xlink:href="#icon-search"></use></svg>',
    ];
