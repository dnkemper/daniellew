...
/**
 * Plugin implementation of the 'media_entity_download_download_source' formatter.
 *
 * @FieldFormatter(
 *   id = "media_entity_download_download_source",
 *   label = @Translation("Download Source"),
 *   field_types = {
 *     "file",
 *     "image"
 *   }
 * )
 */
class DownloadSourceFieldFormatter extends LinkFormatter {
