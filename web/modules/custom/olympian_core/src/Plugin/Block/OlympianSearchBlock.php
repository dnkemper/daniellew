...
namespace Drupal\olympian_core\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "olympian_search_api_form_block",
 *   admin_label = @Translation("Search Block"),
 *   category = @Translation("Site custom")
 * )
 */
class OlympianSearchBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $block['form'] = $this->formBuilder->getForm(
      'Drupal\olympian_core\Form\OlympianSearchApiForm',
      $params,
    );
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['query_parameter'] = [
      ...
      '#placeholder_text' => $this->t('WHAT ARE YOU LOOKING FOR?'),
    ];
    $form['advanced'] = [
      '#type' => 'details',
