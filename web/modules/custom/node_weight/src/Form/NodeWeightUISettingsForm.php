...
class NodeWeightUISettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['entity_types']  = [
      ...
      '#default_value' => $this->config('node_weight.settings')->get('entity_types'),
    ];
    ...
    $form['check_edit_access'] = [
      ...
      '#default_value' => $this->config('node_weight.settings')->get('check_edit_access'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('node_weight.settings')
