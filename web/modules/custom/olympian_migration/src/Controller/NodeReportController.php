 ...
 */
class NodeReportController extends ControllerBase {
  ...
  public function contentTypeList() {
    ...
    foreach ($content_types as $content_type) {
      $content_type_names[] = $content_type->id();
    }

    return [
      '#theme' => 'item_list',
      '#items' => $content_type_names,
      '#title' => $this->t('Content Type Machine Names'),
    ];
  }
  /**
   * Builds the response.
  ...
  public function build() {
    ...
    $paragraphs_types = $this->entityTypeManager()->getStorage('node_type')->loadMultiple();
