...
use Drupal\olympian_migration\Plugin\migrate\CreateMediaTrait;
...
class CreateMediaFromFile extends FileCopy {
  ...
  public function __construct(array $configuration, $plugin_id, array $plugin_definition, StreamWrapperManagerInterface $stream_wrappers, FileSystemInterface $file_system, MigrateProcessInterface $download_plugin) {
    ...
    $this->sourceBaseUrl = \Drupal::config('migrate_plus.migration_group.olympian_migration')
      ->get('shared_configuration.source.constants.source_base_path');
    $this->sourcePublicFilePath = \Drupal::config('migrate_plus.migration_group.olympian_migration')
      ->get('shared_configuration.source.constants.source_base_path');
