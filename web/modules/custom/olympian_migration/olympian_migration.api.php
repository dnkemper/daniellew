 ...
 *
 * @see \Drupal\olympian_migration\Plugin\migrate\source\d7\D7Webform::buildFormElements()
 */
function hook_olympian_migration_d7_webform_element_ELEMENT_TYPE_alter(&$markup, $indent, array $element) {
 ...
 *   the machine-readable element name.
 *
 * @see \Drupal\olympian_migration\Plugin\migrate\source\d6\D6Webform::buildFormElements()
 */
function hook_olympian_migration_d6_webform_element_ELEMENT_TYPE_alter(&$markup, $indent, array $element) {
  // Define custom webform element type from contrib or custom module.
  $markup .= "$indent  '#type': your_custom_type\n";
