...
class LullabotMedia extends LullabotMigrationService {
  ...
  public function createMediaUri($uri, $attributes) {
    ...
    $values = [
      ...
      'status' => TRUE,
      'created' => !empty($attributes['created']) ? $attributes['created'] : \Drupal::time()->getRequestTime(),
      'changed' => !empty($attributes['changed']) ? $attributes['changed'] : \Drupal::time()->getRequestTime(),
