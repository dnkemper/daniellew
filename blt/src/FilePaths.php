...
namespace Artsci\DrupalEnvironmentDetector;
...
class FilePaths {
  ...
  public static function ahSettingsFile(string $ah_group, string $site_name) {
    ...
    return "/var/www/html/d9main/$site_name-settings.inc";
  }
  ...
  public static function acsfSitesJson(string $ah_group, string $ah_env) {
    return "/var/www/html/d9main/multisite-config.json";
  }
   ...
   */
  public static function ahFilesRoot(string $ah_group, string $site_name) {
    if ($site_name === 'default') {
      $site_name = $ah_group;
    }
    $site_name = str_replace('.', '_', $site_name);
    return '/home/drupaladm/d9main/web/sites/' . $site_name . './files';
  }
