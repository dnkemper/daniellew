...
if [ "$SHARED_DEPS_ONLY" = true ]; then
    ...
    ddev drush $DRUSH_ALIAS migrate:import d7_taxonomy_vocabulary --update --continue-on-failure
...
ddev drush mim d7_webform --execute-dependencies --continue-on-failure --update
